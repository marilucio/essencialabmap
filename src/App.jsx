...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  A primeira ferramenta que combina análise facial com biomarcadores metabólicos, 
                  baseada em estudos científicos de alto impacto. Transforme a forma como você 
                  avalia a saúde dos seus pacientes.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <span className="relative z-10">Acesso Imediato - 7 Dias Grátis</span>
                  ...
                  <div className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex items-center justify-center relative overflow-hidden">
                    {!isVideoPlaying ? (
                      <div className="text-center">
                        <div className="w-20 h-20 bg-gradient-to-r from-blue-600 to-green-600 rounded-full flex items-center justify-center mx-auto mb-4 cursor-pointer hover:scale-110 transition-transform duration-300"
                             onClick={() => setIsVideoPlaying(true)}>
                          <Play className="w-8 h-8 text-white ml-1" />
                        </div>
                        <p className="text-gray-600 font-medium">Vídeo: Como o MAP Funciona</p>
                        <p className="text-sm text-gray-500">2 min • Demonstração prática</p>
                      </div>
                    ) : (
                      <iframe
            ...
            {[
              ...
              <Card key={index} className="relative border-2 hover:border-blue-200 transition-all duration-300 hover:shadow-lg">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardDescription className="font-semibold text-gray-700">{step.subtitle}</CardDescription>
                </CardHeader>
                <CardContent>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              O MAP não é apenas tecnologia - é ciência aplicada. Nossa metodologia está 
              fundamentada em pesquisas peer-reviewed das mais renomadas publicações científicas mundiais.
            </p>
          </div>
            ...
            {[
              {
                ...
                image: "/src/assets/prints/estudo-1-network-analysis-metabolic.jpeg",
              ...
              },
              {
                ...
                image: "/src/assets/prints/estudo-2-glycation-oxidation-inflammation.png",
              ...
              },
              {
                ...
                image: "/src/assets/prints/estudo-3-facial-phenotyping-deep-learning.png",
              ...
              <Card key={index} className="hover:shadow-xl transition-all duration-300 border-2 hover:border-blue-200">
                ...
                <CardContent className="space-y-4">
                  <div>
                    <p className="text-sm font-semibold text-gray-700 mb-1">Descoberta:</p>
                    <p className="text-sm text-gray-600 italic">"{study.finding}"</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-gray-700 mb-1">Aplicação MAP:</p>
                  ...
                  <Button 
                    ...
                    size="sm" 
                    className="w-full"
                    onClick={() => window.open(study.link, '_blank', 'noreferrer')}
                  >
            ...
            {[
              {
                ...
                description: "Substitua horas de exames laboratoriais por 30 segundos de análise. Seus pacientes vão amar a praticidade, você vai amar a eficiência.",
                color: "yellow"
              },
              {
                icon: Target,
              ...
              },
              {
                ...
                description: "Seja o primeiro na sua região a oferecer análise metabólica por IA. Destaque-se da concorrência com tecnologia de ponta.",
                color: "purple"
              },
              {
                icon: Shield,
                title: "Prevenção Ativa",
                description: "Identifique riscos metabólicos antes que se tornem problemas. Seus pacientes agradecerão pela abordagem preventiva.",
                color: "green"
              },
              {
                icon: TrendingUp,
                title: "ROI Imediato",
                description: "Aumente o valor percebido das suas consultas. Cobre mais por um serviço diferenciado e baseado em ciência.",
                color: "orange"
              },
              {
                icon: BarChart3,
                title: "Acompanhamento Contínuo",
                description: "Monitore a evolução metabólica dos pacientes ao longo do tempo. Comprove a eficácia dos seus tratamentos.",
                color: "indigo"
              }
            ].map((benefit, index) => (
              <Card key={index} className="hover:shadow-lg transition-all duration-300 border-2 hover:border-blue-200">
                <CardHeader>
                  <div className={`w-12 h-12 rounded-lg bg-gradient-to-r ${
                    benefit.color === 'yellow' ? 'from-yellow-400 to-yellow-500' :
      ...
      {/* Lead Capture - Ebook */}
      <section id="lead-capture-form" className="py-20 bg-gradient-to-br from-green-50 to-blue-50">
            ...
            <div className="relative z-10">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Um guia prático e científico para transformar a saúde dos seus pacientes 
                  através de hábitos baseados em evidências. Mais de 2.347 profissionais já baixaram!
                </p>
              </div>

              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">O que você vai descobrir:</h3>
                  ...
                  {!showSuccess ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600 mb-4">
                        Verifique seu email. O guia foi enviado para <strong>{email}</strong>
                      </p>
                      <Button 
                        ...
                        onClick={() => window.open('https://essencialab.app', '_blank')}
                      >
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-green-50">
        <div className="container mx-auto max-w-6xl px-4">
            ...
            {[
              {
                name: "Dr. Ana Silva",
                role: "Nutricionista",
                content: "O MAP revolucionou minha prática. Consigo mostrar aos pacientes, de forma visual e científica, exatamente onde estão os desequilíbrios metabólicos. A adesão ao tratamento aumentou 300%.",
                rating: 5
              },
              {
              ...
              },
              {
                ...
                role: "Biomédica",
                content: "Meus pacientes ficam impressionados com a precisão da análise. É incrível como uma foto pode revelar tanto sobre a saúde metabólica. Recomendo para todos os colegas.",
                rating: 5
              }
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              { number: "2.347", label: "Análises esta semana", sublabel: "156 novos profissionais ontem" },
              { number: "94%", label: "Satisfação dos usuários", sublabel: "Recomendariam para colegas" },
              { number: "4.8/5", label: "Avaliação média", sublabel: "Baseado em 847 reviews" },
              { number: "340%", label: "ROI médio", sublabel: "No primeiro mês de uso" }
            ].map((stat, index) => (
        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                answer: "Nossos usuários reportam ROI médio de 340% no primeiro mês. Você pode cobrar mais por consultas diferenciadas, aumentar a adesão dos pacientes e otimizar seu tempo. O MAP se paga rapidamente."
              },
              {
                question: "Funciona na minha especialidade?",
                answer: "Sim! O MAP é usado com sucesso por nutricionistas, nutrólogos, biomédicos, médicos, enfermeiros e outros profissionais. A análise metabólica é universal e aplicável a todas as áreas da saúde."
              },
              {
                question: "É realmente científico? Posso confiar nos resultados?",
                answer: "Totalmente! Nossa metodologia está baseada em 728+ citações científicas, incluindo estudos publicados na Nature Medicine. A precisão de 91% foi validada em milhares de casos reais."
              },
              {
                question: "E se eu não gostar? Posso cancelar?",
                answer: "Claro! Oferecemos 7 dias de trial gratuito sem compromisso. Não precisa nem colocar dados do cartão. Se não ficar satisfeito, pode cancelar a qualquer momento. Garantia de satisfação 100%."
              },
              {
                question: "Como funciona o suporte? Vou ficar sozinho?",
                answer: "Jamais! Temos suporte técnico dedicado, material de treinamento exclusivo, comunidade de profissionais e acompanhamento personalizado. Você nunca estará sozinho nessa jornada."
              }
            ].map((faq, index) => (
          ...
          <div className="text-center mt-12">
            ...
            <Button 
              ...
              onClick={() => window.open('https://wa.me/5543991246422?text=Olá! Tenho interesse no MAP e gostaria de falar com um especialista.', '_blank')}
            >
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-green-600 text-white">
        <div className="container mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Não deixe seus concorrentes saírem na frente. A revolução da avaliação metabólica 
            já começou, e você pode fazer parte dela agora mesmo.
          </p>
