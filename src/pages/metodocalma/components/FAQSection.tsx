  ...
  const faqs = [
    {
      ...
      answer: "Sim! O Método CALMA# foi desenvolvido com base em neurociência e testado com mais de 1.847 brasileiros. As técnicas são projetadas para ativar o sistema nervoso parassimpático rapidamente, proporcionando alívio imediato da ansiedade e preparando a mente para o sono reparador."
    },
    {
