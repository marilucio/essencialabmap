      ...
      <div className="container mx-auto container-responsive relative z-10">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-responsive text-green-100 max-w-3xl mx-auto leading-relaxed">
            Teste o Método CALMA# sem nenhum risco. Se não conseguir sua
            primeira noite tranquila, devolvemos todo o seu dinheiro. Sem
          ...
          <Card className="bg-white text-gray-800 p-6 lg:p-10 rounded-2xl shadow-glow border-4 border-yellow-400">
            ...
            <div className="text-center mb-8 lg:mb-12">
              ...
              <p className="text-base lg:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
                Experimente o método por 14 dias completos. Se por qualquer
                motivo você não ficar satisfeito, devolvemos{" "}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-8 lg:mb-12">
              {guaranteeFeatures.map((feature, index) => (
                <div
                  key={index}
                  className="text-center p-4 lg:p-6 bg-gray-50 rounded-xl border border-gray-200"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 text-sm lg:text-base">
              <div className="text-center">
                ...
                <p className="text-white/80 leading-relaxed">
                  Sabemos que o método funciona. 94% dos usuários têm sucesso na
                  primeira noite.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-white/80 leading-relaxed">
                  Nosso objetivo é sua transformação, não apenas a venda. Sua
